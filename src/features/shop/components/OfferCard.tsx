...
}: { title: string; subtitle: string; description: string; image?: any }) {
  const t = useTheme();
  return (
    <View style={[
      styles.card,
...
const styles = StyleSheet.create({
  card: { borderWidth: StyleSheet.hairlineWidth, borderRadius: 16, padding: 14, flexDirection: "row", alignItems: "center", gap: 10 },
});
